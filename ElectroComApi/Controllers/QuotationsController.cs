    ...
    public class QuotationsController : ControllerBase
    {
        ...
        public async Task<ActionResult<QuotationResponseDto>> CreateQuotationRequest([FromBody] List<ProductRequestDto> productRequests)
        {
            ...
            foreach (var req in productRequests)
            {
                ...
                var mappedProductId = await _distributorMappingService.GetDistributorIdAsync(req.ProductId, "electrocom");
            ...
            var distributorId = await _distributorMappingService.GetDistributorIdAsync(productRequests.First().ProductId, "electrocom");
